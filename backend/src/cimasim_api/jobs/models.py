...
class NetlistPreflightResponse(BaseModel):
    ...
    sandbox_ready: bool
    # Populated only for server-managed templates (e.g. sky130_floating_bulk_v1),
    # where the netlist is generated by trusted code and shown read-only for
    # transparency. None for the free-form custom template.
    netlist: str | None = None
